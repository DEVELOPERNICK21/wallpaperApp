...
const SuccessfullyReset: React.FC = () => {
    ...
    <KeyboardAvoidingView
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <ChangedDone_Icon height={height / 2.5} width={width / 1.5} />
          <Text style={styles?.titleStyle}>Password Reset Successfully!</Text>
